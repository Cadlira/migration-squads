...
## Missão
Conduzir análise aprofundada do legado JNLP/Java Web Start (mapeamento de dependências, validação de uso ativo e impacto em satélites) e executar remoção completa com segurança em projetos Java complexos (20+ anos).
